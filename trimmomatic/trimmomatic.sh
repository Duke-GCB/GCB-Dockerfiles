...
# CONT_PARAM_ADDITIONAL_STEPS default LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 MINLEN:10
#
# OUTPUTS
#
...
ADDITIONAL_STEPS="LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 MINLEN:10"
THREADS="-threads 1"
